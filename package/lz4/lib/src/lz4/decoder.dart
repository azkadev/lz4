...
import 'stubs/decompress_filter.dart' if (dart.library.io) 'ffi/decompress_filter.dart';
...
class Lz4Decoder extends CodecConverter {
  ...
  Lz4Decoder({this.inputBufferLength = lz4DecoderInputBufferLength, this.outputBufferLength = lz4DecoderOutputBufferLength});
...
class _Lz4DecoderSink extends CodecSink {
  _Lz4DecoderSink._(ByteConversionSink sink, int inputBufferLength, int outputBufferLength) : super(sink, _makeLz4DecompressFilter(inputBufferLength, outputBufferLength));
}
...
CodecFilter _makeLz4DecompressFilter(int inputBufferLength, int outputBufferLength) => Lz4DecompressFilter(inputBufferLength, outputBufferLength);
